...
~~~
sudo pacman -S --noconfirm --needed qtile alsa-utils polybar polkit-gnome xdg-desktop-portal-gtk rofi clipton fastfetch xclip flameshot picom zsh gnome-characters nemo wezterm gnome-system-monitor discord dunst fontconfig unzip lsd bat
