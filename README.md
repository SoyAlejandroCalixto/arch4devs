...
~~~
sudo pacman -S --noconfirm --needed hyprland hyprpaper alsa-utils waybar polkit-kde-agent xdg-desktop-portal-hyprland rofi-wayland clipton fastfetch wl-clipboard zsh rofimoji ranger wezterm neovim discord obsidian dunst fontconfig zip unzip p7zip lsd bat
