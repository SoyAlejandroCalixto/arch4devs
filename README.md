...
~~~
sudo pacman -S --noconfirm --needed qtile alsa-utils polybar polkit-gnome rofi fastfetch xclip flameshot picom zsh gnome-characters nemo alacritty gnome-system-monitor discord dunst fontconfig unzip lsd bat
